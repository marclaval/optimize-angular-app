 ...
 */
/* tslint:disable */
System.register(['./xsjjv', '@angular/core/src/linker/view', '@angular/core/src/linker/view_utils', '@angular/core/src/metadata/view', '@angular/core/src/linker/view_type', '@angular/core/src/change_detection/constants', '@angular/core/src/linker/component_factory'], function(exports_1, context_1) {
    "use strict";
    ...
    var Wrapper_Xsjjv, renderType_Xsjjv_Host, View_Xsjjv_Host_0, XsjjvNgFactory, styles_Xsjjv, renderType_Xsjjv, View_Xsjjv_0;
    return {
        setters:[
            function (import0_1) {
                import0 = import0_1;
        ...
        execute: function() {
            Wrapper_Xsjjv = (function () {
                ...
                Wrapper_Xsjjv.prototype.ngDoCheck = function (view, el) {
                    var changed = this._changed;
                    this._changed = false;
                    return changed;
                };
                Wrapper_Xsjjv.prototype.checkHost = function (view, componentView, el) {
                };
            ...
            View_Xsjjv_Host_0 = (function (_super) {
                __extends(View_Xsjjv_Host_0, _super);
                function View_Xsjjv_Host_0(viewUtils, parentView, parentIndex, parentElement) {
                    _super.call(this, View_Xsjjv_Host_0, renderType_Xsjjv_Host, import5.ViewType.HOST, viewUtils, parentView, parentIndex, parentElement, import6.ChangeDetectorStatus.CheckAlways);
                }
                View_Xsjjv_Host_0.prototype.createInternal = function (rootSelector) {
                    this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer, 'd-xsjjv', import3.EMPTY_INLINE_ARRAY, rootSelector, null);
                    this.compView_0 = new View_Xsjjv_0(this.viewUtils, this, 0, this._el_0);
                ...
                View_Xsjjv_Host_0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
                    if (((token === import0.Xsjjv) && (0 === requestNodeIndex))) {
                        return this._Xsjjv_0_3.context;
                    }
                    return notFoundResult;
                };
                View_Xsjjv_Host_0.prototype.detectChangesInternal = function () {
                    this._Xsjjv_0_3.ngDoCheck(this, this._el_0);
                    this.compView_0.internalDetectChanges(this.throwOnChange);
                };
                View_Xsjjv_Host_0.prototype.destroyInternal = function () {
                    this.compView_0.destroy();
                };
                View_Xsjjv_Host_0.prototype.visitRootNodesInternal = function (cb, ctx) {
                    cb(this._el_0, ctx);
                };
                return View_Xsjjv_Host_0;
            }(import1.AppView));
            exports_1("XsjjvNgFactory", XsjjvNgFactory = new import7.ComponentFactory('d-xsjjv', View_Xsjjv_Host_0, import0.Xsjjv));
            styles_Xsjjv = [];
            renderType_Xsjjv = import3.createRenderComponentType('', 0, import4.ViewEncapsulation.None, styles_Xsjjv, {});
            View_Xsjjv_0 = (function (_super) {
                __extends(View_Xsjjv_0, _super);
                function View_Xsjjv_0(viewUtils, parentView, parentIndex, parentElement) {
                    _super.call(this, View_Xsjjv_0, renderType_Xsjjv, import5.ViewType.COMPONENT, viewUtils, parentView, parentIndex, parentElement, import6.ChangeDetectorStatus.CheckAlways);
                    this._expr_6 = undefined;
                    this._expr_7 = undefined;
                }
                View_Xsjjv_0.prototype.createInternal = function (rootSelector) {
                ...
                View_Xsjjv_0.prototype.detectChangesInternal = function () {
                ...
                View_Xsjjv_0.prototype.handleEvent_4 = function (eventName, $event) {
