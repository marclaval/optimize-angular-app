...
System.register(['./app', '@angular/core/src/linker/view', '@angular/core/src/linker/view_utils', '@angular/core/src/metadata/view', '@angular/core/src/linker/view_type', '@angular/core/src/change_detection/constants', '@angular/core/src/linker/component_factory', '../node_modules/@angular/router/src/directives/router_link.ngfactory', '@angular/core/src/linker/view_container', '../node_modules/@angular/router/src/directives/router_outlet.ngfactory', '@angular/router/src/router', '@angular/router/src/router_state', '@angular/common/src/location/location_strategy', '@angular/router/src/router_outlet_map', '@angular/core/src/linker/component_factory_resolver', '@angular/router/src/directives/router_link', '@angular/router/src/directives/router_outlet'], function(exports_1, context_1) {
    ...
    var Wrapper_App, renderType_App_Host, View_App_Host_0, AppNgFactory, styles_App, renderType_App, View_App_0;
    return {
        setters:[
            function (import0_1) {
                import0 = import0_1;
        ...
        execute: function() {
            Wrapper_App = (function () {
                ...
                Wrapper_App.prototype.ngDoCheck = function (view, el) {
                    var changed = this._changed;
                    this._changed = false;
                    return changed;
                };
                Wrapper_App.prototype.checkHost = function (view, componentView, el) {
                };
            ...
            View_App_Host_0 = (function (_super) {
                __extends(View_App_Host_0, _super);
                function View_App_Host_0(viewUtils, parentView, parentIndex, parentElement) {
                    _super.call(this, View_App_Host_0, renderType_App_Host, import5.ViewType.HOST, viewUtils, parentView, parentIndex, parentElement, import6.ChangeDetectorStatus.CheckAlways);
                }
                View_App_Host_0.prototype.createInternal = function (rootSelector) {
                    this._el_0 = import3.selectOrCreateRenderHostElement(this.renderer, 'my-app', import3.EMPTY_INLINE_ARRAY, rootSelector, null);
                    this.compView_0 = new View_App_0(this.viewUtils, this, 0, this._el_0);
                ...
                View_App_Host_0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
                    if (((token === import0.App) && (0 === requestNodeIndex))) {
                        return this._App_0_3.context;
                    }
                    return notFoundResult;
                };
                View_App_Host_0.prototype.detectChangesInternal = function () {
                    this._App_0_3.ngDoCheck(this, this._el_0);
                    this.compView_0.internalDetectChanges(this.throwOnChange);
                };
                View_App_Host_0.prototype.destroyInternal = function () {
                    this.compView_0.destroy();
                };
                View_App_Host_0.prototype.visitRootNodesInternal = function (cb, ctx) {
                    cb(this._el_0, ctx);
                };
                return View_App_Host_0;
            }(import1.AppView));
            exports_1("AppNgFactory", AppNgFactory = new import7.ComponentFactory('my-app', View_App_Host_0, import0.App));
            styles_App = [];
            renderType_App = import3.createRenderComponentType('', 0, import4.ViewEncapsulation.None, styles_App, {});
            View_App_0 = (function (_super) {
                __extends(View_App_0, _super);
                function View_App_0(viewUtils, parentView, parentIndex, parentElement) {
                    _super.call(this, View_App_0, renderType_App, import5.ViewType.COMPONENT, viewUtils, parentView, parentIndex, parentElement, import6.ChangeDetectorStatus.CheckAlways);
                ...
                View_App_0.prototype.createInternal = function (rootSelector) {
                ...
                View_App_0.prototype.injectorGetInternal = function (token, requestNodeIndex, notFoundResult) {
                ...
                View_App_0.prototype.detectChangesInternal = function () {
                    var currVal_13_0_0 = this._arr_45('/');
                    this._RouterLinkWithHref_13_3.check_routerLink(this, currVal_13_0_0, false);
                    this._RouterLinkWithHref_13_3.ngDoCheck(this, this._el_13);
                    var currVal_19_0_0 = this._arr_46('/list');
                    this._RouterLinkWithHref_19_3.check_routerLink(this, currVal_19_0_0, false);
                    this._RouterLinkWithHref_19_3.ngDoCheck(this, this._el_19);
                    var currVal_25_0_0 = this._arr_47('/subscribe');
                    this._RouterLinkWithHref_25_3.check_routerLink(this, currVal_25_0_0, false);
                    this._RouterLinkWithHref_25_3.ngDoCheck(this, this._el_25);
                    var currVal_31_0_0 = this._arr_48('/search');
                    this._RouterLinkWithHref_31_3.check_routerLink(this, currVal_31_0_0, false);
                    this._RouterLinkWithHref_31_3.ngDoCheck(this, this._el_31);
                    this._RouterOutlet_37_5.ngDoCheck(this, this._el_37);
                    this._vc_37.detectChangesInNestedViews(this.throwOnChange);
                    this._RouterLinkWithHref_13_3.checkHost(this, this, this._el_13);
                    this._RouterLinkWithHref_19_3.checkHost(this, this, this._el_19);
                    this._RouterLinkWithHref_25_3.checkHost(this, this, this._el_25);
                    this._RouterLinkWithHref_31_3.checkHost(this, this, this._el_31);
                };
                View_App_0.prototype.destroyInternal = function () {
                ...
                View_App_0.prototype.handleEvent_13 = function (eventName, $event) {
                    this.markPathToRootAsCheckOnce();
                    var result = true;
                    result = (this._RouterLinkWithHref_13_3.handleEvent(eventName, $event) && result);
                    return result;
                };
                View_App_0.prototype.handleEvent_19 = function (eventName, $event) {
                    this.markPathToRootAsCheckOnce();
                    var result = true;
                    result = (this._RouterLinkWithHref_19_3.handleEvent(eventName, $event) && result);
                    return result;
                };
                View_App_0.prototype.handleEvent_25 = function (eventName, $event) {
                    this.markPathToRootAsCheckOnce();
                    var result = true;
                    result = (this._RouterLinkWithHref_25_3.handleEvent(eventName, $event) && result);
                    return result;
                };
                View_App_0.prototype.handleEvent_31 = function (eventName, $event) {
                    this.markPathToRootAsCheckOnce();
                    var result = true;
